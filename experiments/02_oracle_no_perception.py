...
from src.models.coordinate_policy import build_coordinate_based_policy
...
def main(cfg):
    model = build_coordinate_based_policy(config_name=cfg.model_config, seed=cfg.model_seed)
